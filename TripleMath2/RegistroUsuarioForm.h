...
#pragma region Windows Form Designer generated code
		void InitializeComponent(void)
		{
			...
			this->lblUsuario->Location = System::Drawing::Point(211, 116);
			...
			// txtUsuario
			// 
			this->txtUsuario->Location = System::Drawing::Point(162, 146);
			...
			// btnPlay
			// 
			this->btnPlay->Location = System::Drawing::Point(207, 172);
			...
			this->pictureBox1->Image = System::Drawing::Image::FromFile("FondoHorizontalJuego.jpg");
			...
			this->pictureBox1->Click += gcnew System::EventHandler(this, &RegistroUsuarioForm::pictureBox1_Click_1);
			// 
			// RegistroUsuarioForm
			// 
